...
/**
 * This class stands for LimitPerDayException StructType
 * Meta information extracted from the WSDL
 * - type: tns:LimitPerDayException
 * @subpackage Structs
 */
class LimitPerDayException extends AbstractStructBase
{
    /**
     * The limitAmount
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for LimitPerDayException
     * @uses LimitPerDayException::setLimitAmount()
     * @uses LimitPerDayException::setLimitSource()
     * @uses LimitPerDayException::setCurrency()
     * @uses LimitPerDayException::setType()
     ...
     * @param float $limitAmount
     * @return \StructType\LimitPerDayException
     */
