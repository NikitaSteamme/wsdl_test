...
/**
 * This class stands for UserBlockedException StructType
 * Meta information extracted from the WSDL
 * - type: tns:UserBlockedException
 * @subpackage Structs
 */
class UserBlockedException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for UserBlockedException
     * @uses UserBlockedException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\UserBlockedException
     */
