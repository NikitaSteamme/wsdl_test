...
/**
 * This class stands for BadParametersException StructType
 * Meta information extracted from the WSDL
 * - type: tns:BadParametersException
 * @subpackage Structs
 */
class BadParametersException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for BadParametersException
     * @uses BadParametersException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\BadParametersException
     */
