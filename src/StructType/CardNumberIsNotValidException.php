...
/**
 * This class stands for CardNumberIsNotValidException StructType
 * Meta information extracted from the WSDL
 * - type: tns:CardNumberIsNotValidException
 * @subpackage Structs
 */
class CardNumberIsNotValidException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for CardNumberIsNotValidException
     * @uses CardNumberIsNotValidException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\CardNumberIsNotValidException
     */
