...
/**
 * This class stands for RegistrationException StructType
 * Meta information extracted from the WSDL
 * - type: tns:RegistrationException
 * @subpackage Structs
 */
class RegistrationException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for RegistrationException
     * @uses RegistrationException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\RegistrationException
     */
