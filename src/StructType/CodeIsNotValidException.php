...
/**
 * This class stands for CodeIsNotValidException StructType
 * Meta information extracted from the WSDL
 * - type: tns:CodeIsNotValidException
 * @subpackage Structs
 */
class CodeIsNotValidException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for CodeIsNotValidException
     * @uses CodeIsNotValidException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\CodeIsNotValidException
     */
