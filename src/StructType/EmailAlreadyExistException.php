...
/**
 * This class stands for EmailAlreadyExistException StructType
 * Meta information extracted from the WSDL
 * - type: tns:EmailAlreadyExistException
 * @subpackage Structs
 */
class EmailAlreadyExistException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for EmailAlreadyExistException
     * @uses EmailAlreadyExistException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\EmailAlreadyExistException
     */
