...
/**
 * This class stands for TransactionFailureException StructType
 * Meta information extracted from the WSDL
 * - type: tns:TransactionFailureException
 * @subpackage Structs
 */
class TransactionFailureException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for TransactionFailureException
     * @uses TransactionFailureException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\TransactionFailureException
     */
