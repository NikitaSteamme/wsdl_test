...
/**
 * This class stands for CardIsNotActiveException StructType
 * Meta information extracted from the WSDL
 * - type: tns:CardIsNotActiveException
 * @subpackage Structs
 */
class CardIsNotActiveException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for CardIsNotActiveException
     * @uses CardIsNotActiveException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\CardIsNotActiveException
     */
