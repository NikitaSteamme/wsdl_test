...
/**
 * This class stands for LimitPerMonthException StructType
 * Meta information extracted from the WSDL
 * - type: tns:LimitPerMonthException
 * @subpackage Structs
 */
class LimitPerMonthException extends AbstractStructBase
{
    /**
     * The limitAmount
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for LimitPerMonthException
     * @uses LimitPerMonthException::setLimitAmount()
     * @uses LimitPerMonthException::setLimitSource()
     * @uses LimitPerMonthException::setCurrency()
     * @uses LimitPerMonthException::setType()
     ...
     * @param float $limitAmount
     * @return \StructType\LimitPerMonthException
     */
