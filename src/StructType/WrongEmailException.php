...
/**
 * This class stands for WrongEmailException StructType
 * Meta information extracted from the WSDL
 * - type: tns:WrongEmailException
 * @subpackage Structs
 */
class WrongEmailException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for WrongEmailException
     * @uses WrongEmailException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\WrongEmailException
     */
