...
/**
 * This class stands for LifetimeLimitException StructType
 * Meta information extracted from the WSDL
 * - type: tns:LifetimeLimitException
 * @subpackage Structs
 */
class LifetimeLimitException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for LifetimeLimitException
     * @uses LifetimeLimitException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\LifetimeLimitException
     */
