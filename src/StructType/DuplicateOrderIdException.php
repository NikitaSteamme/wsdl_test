...
/**
 * This class stands for DuplicateOrderIdException StructType
 * Meta information extracted from the WSDL
 * - type: tns:DuplicateOrderIdException
 * @subpackage Structs
 */
class DuplicateOrderIdException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for DuplicateOrderIdException
     * @uses DuplicateOrderIdException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\DuplicateOrderIdException
     */
