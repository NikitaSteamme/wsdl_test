...
/**
 * This class stands for LimitPerCardPerDayException StructType
 * Meta information extracted from the WSDL
 * - type: tns:LimitPerCardPerDayException
 * @subpackage Structs
 */
class LimitPerCardPerDayException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for LimitPerCardPerDayException
     * @uses LimitPerCardPerDayException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\LimitPerCardPerDayException
     */
