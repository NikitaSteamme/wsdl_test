...
/**
 * This class stands for WalletDoesNotExist StructType
 * Meta information extracted from the WSDL
 * - type: tns:WalletDoesNotExist
 * @subpackage Structs
 */
class WalletDoesNotExist extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for WalletDoesNotExist
     * @uses WalletDoesNotExist::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\WalletDoesNotExist
     */
