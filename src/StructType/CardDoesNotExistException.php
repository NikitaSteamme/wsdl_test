...
/**
 * This class stands for CardDoesNotExistException StructType
 * Meta information extracted from the WSDL
 * - type: tns:CardDoesNotExistException
 * @subpackage Structs
 */
class CardDoesNotExistException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for CardDoesNotExistException
     * @uses CardDoesNotExistException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\CardDoesNotExistException
     */
