...
/**
 * This class stands for LimitPerQuarterException StructType
 * Meta information extracted from the WSDL
 * - type: tns:LimitPerQuarterException
 * @subpackage Structs
 */
class LimitPerQuarterException extends AbstractStructBase
{
    /**
     * The limitAmount
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for LimitPerQuarterException
     * @uses LimitPerQuarterException::setLimitAmount()
     * @uses LimitPerQuarterException::setLimitSource()
     * @uses LimitPerQuarterException::setCurrency()
     * @uses LimitPerQuarterException::setType()
     ...
     * @param float $limitAmount
     * @return \StructType\LimitPerQuarterException
     */
