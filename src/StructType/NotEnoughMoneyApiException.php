...
/**
 * This class stands for NotEnoughMoneyApiException StructType
 * Meta information extracted from the WSDL
 * - type: tns:NotEnoughMoneyApiException
 * @subpackage Structs
 */
class NotEnoughMoneyApiException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for NotEnoughMoneyApiException
     * @uses NotEnoughMoneyApiException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\NotEnoughMoneyApiException
     */
