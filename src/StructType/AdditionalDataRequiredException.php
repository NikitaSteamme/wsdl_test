...
/**
 * This class stands for AdditionalDataRequiredException StructType
 * Meta information extracted from the WSDL
 * - type: tns:AdditionalDataRequiredException
 * @subpackage Structs
 */
class AdditionalDataRequiredException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for AdditionalDataRequiredException
     * @uses AdditionalDataRequiredException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\AdditionalDataRequiredException
     */
