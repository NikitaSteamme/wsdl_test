...
/**
 * This class stands for UserDoesNotExistException StructType
 * Meta information extracted from the WSDL
 * - type: tns:UserDoesNotExistException
 * @subpackage Structs
 */
class UserDoesNotExistException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for UserDoesNotExistException
     * @uses UserDoesNotExistException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\UserDoesNotExistException
     */
