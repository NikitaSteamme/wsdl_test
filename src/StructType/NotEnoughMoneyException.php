...
/**
 * This class stands for NotEnoughMoneyException StructType
 * Meta information extracted from the WSDL
 * - type: tns:NotEnoughMoneyException
 * @subpackage Structs
 */
class NotEnoughMoneyException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for NotEnoughMoneyException
     * @uses NotEnoughMoneyException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\NotEnoughMoneyException
     */
