...
/**
 * This class stands for NotSupportedBankBinException StructType
 * Meta information extracted from the WSDL
 * - type: tns:NotSupportedBankBinException
 * @subpackage Structs
 */
class NotSupportedBankBinException extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $type;
    /**
     * Constructor method for NotSupportedBankBinException
     * @uses NotSupportedBankBinException::setType()
     * @param string $type
     */
     ...
     * @param string $type
     * @return \StructType\NotSupportedBankBinException
     */
